...
public class Tour extends AppTour {
    ...
    public void init( Bundle savedInstanceState) {
        ...
        int firstColor = Color.parseColor("@colors/firstColorTour");
        int secondColor = Color.parseColor("@colors/secondColorTour");
        ...
        setSkipText("@strings/tour_skip_text");
        setDoneText("@strings/tour_done_text");
